{
  ...
  home.file = {
    ".config/termusic/server.toml".text = ''
      version = "2"
      ...
      [player]
      music_dirs = ["${config.home.homeDirectory}/Music/Library"]
      ...
      download_dir = "${config.home.homeDirectory}/Music/Downloads"
    '';

    ".config/termusic/tui.toml".text = ''
      version = "2"
      com = "same"
